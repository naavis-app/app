...
const features = [
    ...
    },
    {
        name: "Dashboard",
        description:
            "View and manage all your devices and locations in one place.",
    ...
    return (
        <>
            <Section className="vignette relative flex flex-col overflow-clip bg-slate-100 font-sans">
                <Container
                    size="2"
                    className="mt-[30vh] h-full w-full p-8 text-center"
                >
                    <Flex direction="column" className="">
                        <Text size="9">
                            ...
                            <Strong className="relative">
                                Connected,
                                <div className="absolute right-0 top-0 h-5 w-5 animate-ping rounded-full bg-blue-500"></div>
                            </Strong>
                        </Text>
                ...
                <motion.div
                    ...
                    className={clsx(
                        `absolute -z-10 !rotate-[${Math.round(p * 360)}deg]`,
                    )}
                >
                    <Image
                        src="/lmap.svg"
