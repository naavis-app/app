...
export default function GroupSelector() {
	return (<>
		<div className="mx-auto left-0 right-0 mt-4 absolute z-10 w-fit">
			<Select.Root defaultValue="2">
				<Select.Trigger radius="full" variant="classic" className="z-10" />
				<Select.Content className="z-10" position="popper" variant="solid">
					<Select.Group>
